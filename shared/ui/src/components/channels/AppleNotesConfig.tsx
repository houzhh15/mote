// ================================================================
// AppleNotesConfig - Apple Notes channel configuration modal
// ================================================================
    ...
    >
      <Form
        ...
        initialValues={config || {
          ...
          reply: { prefix: '[Mote 回复]', separator: '\n' },
      ...
      >
        ...
        <Form.Item
          name="watchFolder"
          label="监控文件夹"
          rules={[{ required: true, message: '请输入要监控的 Notes 文件夹名称' }]}
          tooltip="只会处理此文件夹中的笔记"
        >
          <Input placeholder="Mote Inbox" />
        </Form.Item>
        <Form.Item
          name="archiveFolder"
          label="归档文件夹"
          tooltip="处理完成后将笔记移动到此文件夹（留空则不移动）"
        >
          <Input placeholder="Mote Archive" />
        </Form.Item>
        <Form.Item
          name="pollInterval"
          label="轮询间隔"
